...
contracts NFTMarket is ReentrancyGuard, ERC721 {
    ...
    //a way to accessvalues of the marketItem struct above by passing an integer id
    ...
    /// @notice function to create a marketItem
